...
Edit the files and stop there. Committing, branching, pushing, and opening the pull request are handled for you afterwards, so do not do them and do not offer to. Do not ask which branch or remote to use.

Finish with a short factual summary of what you changed and why. No offers of further help, no next steps, no questions about what to do with the change.`;
